...
public class TestPanel1 extends JPanel {
    ...
    private JPanel getContentPanel() {
        ...
        welcomeTitle.setText("Welcome to the Mascot Percolator Wizard V1.0!");
        contentPanel1.add(welcomeTitle, java.awt.BorderLayout.NORTH);

        jPanel1.setLayout(new java.awt.GridLayout(0, 1));

        jPanel1.add(blankSpace);
        jLabel1.setText("This tool allows you to setup and run the stand alone Mascot Percolator.");
        jPanel1.add(jLabel1);
        jLabel2.setText("You will be required to enter some details which will allow you to run  ");
        jPanel1.add(jLabel2);
